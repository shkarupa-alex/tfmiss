...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dropout", type=float, default=0.1, help="Dropout applied to layers"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="Total sequence length, including effective history",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Number of negative examples for sampled softmaxes",
    )
    ...
    train_dataset, test_dataset, vocab_size = data_generator(
        argv.seq_len, argv.batch_size
    )
    ...
    titles = [
        ...
        "AdaptiveSoftmax (accurate)",
        "AdaptiveSoftmax (fast)",
    ]
    models = [
        Text8Model(
