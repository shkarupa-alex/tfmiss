// Taken from https://raw.githubusercontent.com/tensorflow/text/v2.5.0/tensorflow_text/core/ops/wordpiece_op.cc
//
...
Status WordpieceTokenizeShapeFn(InferenceContext* c);

REGISTER_OP("Miss>WordpieceTokenize")
    ...
    .SetShapeFn(WordpieceTokenizeShapeFn)
    .Doc(R"doc(
