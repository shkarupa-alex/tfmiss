...
template struct ModulatedDeformableColumnBackwardFunctor<CPUDevice, Eigen::bfloat16, float>;
template struct ModulatedDeformableColumnBackwardFunctor<CPUDevice, Eigen::half, float>;
template struct ModulatedDeformableColumnBackwardFunctor<CPUDevice, float, float>;
template struct ModulatedDeformableColumnBackwardFunctor<CPUDevice, double, double>;
...
template struct CastFloatFunctor<CPUDevice, Eigen::half>;
template struct CastFloatFunctor<CPUDevice, Eigen::bfloat16>;
