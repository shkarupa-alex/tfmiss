...
class QRNNTest(testing.TestCase):
    ...
    def test_layer(self):
        self.run_layer_test(
            QRNN,
            init_kwargs={'units': 8, 'window': 2, 'zoneout': 0., 'output_gate': True, 'zero_output_for_mask': True,
        ...
        self.run_layer_test(
            QRNN,
            init_kwargs={'units': 8, 'window': 2, 'zoneout': 0., 'output_gate': True,
        ...
        self.run_layer_test(
            QRNN,
            init_kwargs={'units': 8, 'window': 3, 'zoneout': 0., 'output_gate': True,
                         'return_sequences': False, 'return_state': False, 'go_backwards': False},
            input_shape=(10, 5, 3),
            input_dtype='float32',
            expected_output_dtype='float32',
        ...
        self.run_layer_test(
            QRNN,
            init_kwargs={'units': 8, 'window': 2, 'zoneout': 0.1, 'output_gate': True,
                         'return_sequences': False, 'return_state': False, 'go_backwards': False},
            input_shape=(10, 5, 3),
            input_dtype='float32',
            expected_output_dtype='float32',
        ...
        self.run_layer_test(
            QRNN,
            init_kwargs={'units': 8, 'window': 2, 'zoneout': 0., 'output_gate': False,
                         'return_sequences': False, 'return_state': False, 'go_backwards': False},
            input_shape=(10, 5, 3),
            input_dtype='float32',
            expected_output_dtype='float32',
    ...
    def test_model(self):
        model = models.Sequential([
            layers.Bidirectional(QRNN(units=12, window=2, zoneout=0.2, return_sequences=True)),
