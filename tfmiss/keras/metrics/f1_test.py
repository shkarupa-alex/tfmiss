...
class F1BinaryTest(testing.TestCase):
    ...
    def test_reset_states(self):
        ...
        model.evaluate(x, y)
        self.assertEqual(f1_obj.precision.true_positives, 0.)
        self.assertEqual(f1_obj.precision.false_positives, 100.)
        self.assertEqual(f1_obj.recall.true_positives, 0.)
        self.assertEqual(f1_obj.recall.false_negatives, 0.)
    ...
    def test_metric_rises(self):
        ...
        model.compile(loss='binary_crossentropy', metrics=[f1_obj], optimizer='adam')
...
class F1MicroTest(testing.TestCase):
    ...
    def test_reset_states(self):
        ...
        model.evaluate(x, y)
        self.assertEqual(f1_obj.precision.true_positives, 100.)
        self.assertEqual(f1_obj.precision.false_positives, 0.)
        self.assertEqual(f1_obj.recall.true_positives, 100.)
        self.assertEqual(f1_obj.recall.false_negatives, 0.)
    ...
    def test_metric_rises(self):
        ...
        model.compile(
            loss='sparse_categorical_crossentropy', metrics=[f1_obj], optimizer='adam')
        x = np.random.rand(100, 4)
        y = (x.mean(-1) > 0.5).astype('int32')
...
class F1MacroTest(testing.TestCase):
    ...
    def test_reset_states(self):
        ...
        model.evaluate(x, y)
        self.assertEqual(f1_obj.class2f1[0].precision.true_positives, 100.)
        self.assertEqual(f1_obj.class2f1[0].precision.false_positives, 0.)
        self.assertEqual(f1_obj.class2f1[0].recall.true_positives, 100.)
        self.assertEqual(f1_obj.class2f1[0].recall.false_negatives, 0.)
        self.assertEqual(f1_obj.class2f1[1].precision.true_positives, 0.)
        self.assertEqual(f1_obj.class2f1[1].precision.false_positives, 0.)
        self.assertEqual(f1_obj.class2f1[1].recall.true_positives, 0.)
        self.assertEqual(f1_obj.class2f1[1].recall.false_negatives, 0.)
    ...
    def test_metric_rises(self):
        ...
        model.compile(loss='sparse_categorical_crossentropy', metrics=[f1_obj], optimizer='adam')
        x = np.random.rand(100, 4)
        y = (x.mean(-1) > 0.5).astype('int32')
