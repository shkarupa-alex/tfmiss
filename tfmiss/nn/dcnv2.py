...
def modulated_deformable_column(
    ...
    Args:
        ...
        offset: Tensor, offset values with shape
          [N, Hout, Wout, deformable_group * kernel_height * kernel_width * 2]
        mask: Tensor, mask values with shape
          [N, Hout, Wout, deformable_group * kernel_height * kernel_width]
        kernel_size: An integer or tuple/list of 2 integers, the height and
          width of the 2D convolution window.
        strides: An integer or tuple/list of 2 integers, the strides of the
          convolution along the height and width.
        padding: An integer or tuple/list of 2 integers, the explicit paddings
          for the input along the height and width.
        dilation_rate: An integer or tuple/list of 2 integers, the dilation
          rate to use for dilated convolution.
        deformable_groups: A positive integer, the number of groups in which
          the input is split along the channel axis. Each group uses it's own
          offset and mask values.
        name: A name for the operation (optional).
    Returns:
        Tensor: values of shape
          [N, Hout * Wout, C * kernel_height * kernel_width] sampled from input
          with respect to offset, mask and other convolution parameters.
    """
